...
public class ChooseDormForMore extends Activity implements View.OnClickListener{
    ...
    private EditText id1, vcode1, id2, vcode2, id3, vcode3;
    private String id1_str,vcode1_str, id2_str, vcode2_str ,id3_str, vcode3_str;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case UPDATE_ROOM_INFO:
                        ...
                        break;
                    case SUCCESS_INFO:
                        Intent i = new Intent(ChooseDormForMore.this, SuccessNotify.class);
                        startActivityForResult(i, 1);
                        break;
                    case FAIL_INFO:
                        Toast.makeText(ChooseDormForMore.this, "办理失败！", Toast.LENGTH_LONG).show();
                        break;
                    default:
                        break;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choose_dorm_4);
        //初始化登录界面
        initView();
        initHandler();
        queryRoomInfo();
    ...
    private void initView() {
        ...
        name = (TextView)findViewById(R.id.cd4_name);
        id = (TextView)findViewById(R.id.cd4_id);
        gender = (TextView)findViewById(R.id.cd4_gender);
        building5 = (TextView)findViewById(R.id.cd4_building5);
        building13 = (TextView)findViewById(R.id.cd4_building13);
        building14 = (TextView)findViewById(R.id.cd4_building14);
        ...
        mEnsureBtn = (Button)findViewById(R.id.ensure_button_4);
        mEnsureBtn.setOnClickListener(this);

        spinner = (Spinner) findViewById(R.id.spinner_4);
        //建立数据源
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ensure_button_4){
            SharedPreferences sharedPreferences = getSharedPreferences("config", MODE_PRIVATE);
            ...
            params.put("stu3id",id3_str);
            params.put("v3code", vcode3_str);
    ...
    private void initEditViewer() {
        id1 = (EditText)findViewById(R.id.cd4_id1);
        id2 = (EditText)findViewById(R.id.cd4_id2);
        id3 = (EditText)findViewById(R.id.cd4_id3);
        vcode1 = (EditText)findViewById(R.id.cd4_vcode1);
        vcode2 = (EditText)findViewById(R.id.cd4_vcode2);
        vcode3 = (EditText)findViewById(R.id.cd4_vcode3);
        ...
        id3.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                id3_str = id3.getText().toString().trim();
            }
        ...
        vcode3.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                vcode3_str = vcode3.getText().toString().trim();
            }
