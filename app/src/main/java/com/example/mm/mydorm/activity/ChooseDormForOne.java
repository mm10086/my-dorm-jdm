...
public class ChooseDormForOne extends Activity implements View.OnClickListener {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case UPDATE_ROOM_INFO:
                        ...
                        break;
                    case SUCCESS_INFO:
                        Intent i = new Intent(ChooseDormForOne.this, SuccessNotify.class);
                        startActivityForResult(i, 1);
                        break;
                    case FAIL_INFO:
                        Toast.makeText(ChooseDormForOne.this, "办理失败！", Toast.LENGTH_LONG).show();
                        break;
                    default:
                        break;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choose_dorm_1);
        //初始化登录界面
        initView();
        initHandler();
        queryRoomInfo();
    ...
    private void initView() {
        ...
        name = (TextView)findViewById(R.id.cd1_name);
        id = (TextView)findViewById(R.id.cd1_id);
        gender = (TextView)findViewById(R.id.cd1_gender);
        building5 = (TextView)findViewById(R.id.cd1_building5);
        building13 = (TextView)findViewById(R.id.cd1_building13);
        building14 = (TextView)findViewById(R.id.cd1_building14);

        name.setText(name_str);
        id.setText(id_str);
        gender.setText(gender_str);

        mEnsureBtn = (Button)findViewById(R.id.ensure_button);
