...
public class ChooseDormForTwo extends Activity implements View.OnClickListener {
    ...
    private EditText id1, vcode1;
    private String id1_str,vcode1_str;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case UPDATE_ROOM_INFO:
                        ...
                        break;
                    case SUCCESS_INFO:
                        Intent i = new Intent(ChooseDormForTwo.this, SuccessNotify.class);
                        startActivityForResult(i, 1);
                        break;
                    case FAIL_INFO:
                        Toast.makeText(ChooseDormForTwo.this, "办理失败！", Toast.LENGTH_LONG).show();
                        break;
                    default:
                        break;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choose_dorm_2);
        //初始化登录界面
        initView();
        initHandler();
        queryRoomInfo();
    ...
    private void initView() {
        ...
        name = (TextView)findViewById(R.id.cd2_name);
        id = (TextView)findViewById(R.id.cd2_id);
        gender = (TextView)findViewById(R.id.cd2_gender);
        building5 = (TextView)findViewById(R.id.cd2_building5);
        building13 = (TextView)findViewById(R.id.cd2_building13);
        building14 = (TextView)findViewById(R.id.cd2_building14);
        ...
        mEnsureBtn = (Button)findViewById(R.id.ensure_button_2);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ensure_button_2){
            SharedPreferences sharedPreferences = getSharedPreferences("config", MODE_PRIVATE);
    ...
    private void initEditViewer() {
        id1 = (EditText)findViewById(R.id.cd2_id1);
        vcode1 = (EditText)findViewById(R.id.cd2_vcode1);
